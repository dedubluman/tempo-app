...
export default function RequestError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-6 px-4 py-24 text-center">
      ...
      <div className="space-y-2">
        <h1 className="font-[--font-display] text-xl font-bold text-[--text-primary]">Payment Request Error</h1>
