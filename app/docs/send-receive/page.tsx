    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-[--text-secondary] leading-relaxed">
          Enter a recipient Tempo address and a pathUSD amount. Optionally add a
          memo (up to 32 bytes). Click Send, confirm with your passkey, and the
          transfer finalizes on-chain instantly.
        </p>
        <ul className="space-y-1 text-sm text-[--text-secondary] list-disc list-inside">
          ...
          <li>
            Use the &ldquo;Max&rdquo; button to fill in your full available
            balance
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-[--text-secondary] leading-relaxed">
          Switch to Batch mode to send to multiple recipients in a single
          transaction. Add up to 10 recipient rows. The total must not exceed
          your balance. All transfers execute atomically — either all succeed or
          all fail.
        </p>
        <ul className="space-y-1 text-sm text-[--text-secondary] list-disc list-inside">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-[--text-secondary] leading-relaxed">
          Your wallet address is shown on the dashboard. Copy it and share it
          with senders. You can also use the Tempo testnet faucet to fund your
      ...
      <div className="rounded-[--radius-xl] border border-[--status-warning-border] bg-[--status-warning-bg] p-4">
        <p className="text-sm text-[--status-warning-text]">
          <strong>Note:</strong> pathUSD uses 6 decimal places. Maximum
          precision is 6 decimal digits. Amounts with more decimals will be
          rejected.
        </p>
      </div>
    </div>
