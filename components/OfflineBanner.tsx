...
export function OfflineBanner() {
  ...
  return (
    <FeatureGate flag={FeatureFlag.OFFLINE_MODE}>
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-amber-400/35 bg-amber-500/95 px-4 py-3 text-center text-sm font-medium text-[#1f1300] shadow-lg backdrop-blur-sm">
